...
library(tidyverse)
abund = as.data.frame(read_tsv("/Users/yifanli/Documents/PhD/Projects/Algal_microbiome_characterization/Nanopore_pilot/results/pilot_ncbi_q20_95percentsimilarity_gen/abundance_table_genus.tsv"))
row.names(abund)=abund$tax
abund=as.matrix(abund[,-1])

# Import tax table.
taxa <- as.data.frame(read_tsv("/Users/yifanli/Documents/PhD/Projects/Algal_microbiome_characterization/Nanopore_pilot/results/pilot_ncbi_q20_95percentsimilarity_gen/tax_table_genus.tsv"))
row.names(taxa)=taxa$tax
taxa=as.matrix(taxa[,-1])

# Import the metadata.
metadata <- as.data.frame(read_csv("/Users/yifanli/Documents/PhD/Projects/Algal_microbiome_characterization/Nanopore_pilot/results/pilot_ncbi_q20_95percentsimilarity_gen/metadata.csv"))
...
contamdf <- isContaminant(ps_filtered, method="either", conc="DNA_quant_reading", neg="is.neg")
...
zymo_gen=ggplot(data=df_zymo, aes(cultureID), width=0.5) +
  ...
  scale_fill_manual(values=mypalette(9)) + 
  scale_color_manual(values=mypalette(9)) + 
  theme(text=element_text(size=20))
zymo_gen

ggsave("/Users/yifanli/Documents/PhD/Projects/Algal_microbiome_characterization/Nanopore_pilot/results/figures/zymo_ncbi_gen_nounknowns.pdf",zymo_gen, width = 6, height = 10)
...
ggsave("/Users/yifanli/Documents/PhD/Projects/Algal_microbiome_characterization/Nanopore_pilot/results/figures/zymo_ncbi_gen_all.pdf",zymo_gen, width = 6, height = 10)
