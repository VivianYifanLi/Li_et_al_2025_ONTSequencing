...
# Check decontam threshold
hist=hist(contamdf$p)
pdf(file="/Users/yifanli/Documents/PhD/Projects/Algal_microbiome_characterization/Nanopore_pilot/results/figures/suppfigure1a-decontam_hist_ncbi_sp.pdf", width = 6, height = 6)
hist=hist(contamdf$p)
dev.off()
