...
hist(contamdf$p)
pdf(file="/Users/yifanli/Documents/PhD/Projects/Algal_microbiome_characterization/Nanopore_pilot/results/figures/suppfigure1b-decontam_hist_zymo_gen.pdf", width = 6, height = 6)
